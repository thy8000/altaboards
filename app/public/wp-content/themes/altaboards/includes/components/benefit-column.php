...
<div class="w-full flex flex-col-reverse gap-14 <?php echo $is_reverse ?>">
    <div class="flex flex-col gap-5 w-full lg:w-3/5">
        ...
        <a class="bg-jade text-white py-4 px-10 rounded-full flex gap-3.5 items-center justify-center transition-all duration-500 ease-in hover:bg-transparent hover:border hover:text-jade hover:border-jade max-w-[250px]" href="<?php echo $page_contact_link ?>">
