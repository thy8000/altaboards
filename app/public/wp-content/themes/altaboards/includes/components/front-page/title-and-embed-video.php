...
<div class="flex flex-col py-16 gap-20 justify-center lg:flex-row-reverse">
    <div class="w-full lg:w-6/12">
        ...
        <h3 class="text-lg font-normal text-midgray w-full lg:max-w-[450px]">
            <?php esc_html_e('Crie quadros de monitoramento eficientes para gerenciar toda a documentação relevante em um único lugar. Insira datas e prazos facilmente e calcule automaticamente os vencimentos de cada item.') ?>
        </h3>
    </div>
