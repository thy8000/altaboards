...
$plans_list = [
    'basic' => [
        ...
        'services' => [
            ...
            esc_html__('Acesso à informação de todos os fornecedores', 'it9-obrasoft'),
    ...
    'pro' => [
        ...
        'services' => [
            ...
            esc_html__('Todos os serviços do plano básico', 'it9-obrasoft'),
            esc_html__('Análise de desempenho de fornecedores', 'it9-obrasoft'),
            esc_html__('Relatórios personalizados', 'it9-obrasoft'),
    ...
    'enterprise' => [
        ...
        'services' => [
            ...
            esc_html__('Todos os serviços dos planos basic e pro', 'it9-obrasoft'),
